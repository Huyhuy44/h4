...
if __name__ == '__main__':
	commands = f"""{colorama.Fore.LC}HOME{colorama.Fore.LR} ~>{colorama.Fore.LY}Back to home
{colorama.Fore.LC}REF{colorama.Fore.LR} ~> {colorama.Fore.LY}Refresh the menu
{colorama.Fore.LC}CLEAR{colorama.Fore.LR} ~> {colorama.Fore.LY}Clear your face xd
{colorama.Fore.LC}EXIT{colorama.Fore.LR} ~> {colorama.Fore.LY}Exit the program
{colorama.Fore.LC}BBOS{colorama.Fore.LR} ~> {colorama.Fore.LY}L4/L7 DDOS Attack
{colorama.Fore.LC}STOP{colorama.Fore.LR} ~> {colorama.Fore.LY}Stop your Attack
{colorama.Fore.LC}DEV{colorama.Fore.LR} ~> {colorama.Fore.LY}Contact/Support dev"""
	dev = f"""{colorama.Fore.LC}Telegram{colorama.Fore.LR}: {colorama.Fore.LY}https://t.me/ngdangtr
{colorama.Fore.LC}Momo{colorama.Fore.LR}: {colorama.Fore.LY}0965849504"""
